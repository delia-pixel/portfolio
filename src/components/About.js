                ...
                <div className="row skills-content">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="progress">
                            ...
                            <div className="progress-bar-wrap">
                                <div className="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0"
                                     aria-valuemax="100"></div>
                            </div>
                        </div>
                    ...
                    <div className="swiper-wrapper">
                        {/*<div className="swiper-slide">
                            <div className="testimonial-item">
                                ...
                                <img src={require('../assets/images/testimonials/testimonials-1.jpg')} className="testimonial-img"
                                     alt=""/>
                                <h3>Saul Goodman</h3>
                                <h4>Ceo &amp; Founder</h4>
                            </div>
                        ...
                        <div className="swiper-slide">
                            <div className="testimonial-item">
                                ...
                                <img src={require('../assets/images/testimonials/testimonials-3.jpg')} className="testimonial-img"
                                     alt="" />
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                            </div>
                        ...
                        <div className="swiper-slide">
                            <div className="testimonial-item">
                                ...
                                <img src={require('../assets/images/testimonials/testimonials-4.jpg')} className="testimonial-img"
                                     alt="" />
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                            </div>
                        ...
                        <div className="swiper-slide">
                            <div className="testimonial-item">
                                ...
                                <img src={require('../assets/images/testimonials/testimonials-5.jpg')} className="testimonial-img"
                                     alt="" />
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                            </div>
